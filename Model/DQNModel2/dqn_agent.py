...
from Model.DQNModel2.dqn import DQN
from Model.DQNModel2.replay_memory import ReplayMemory
import random
...
class DQNAgent:
    def __init__(self, color, game_service, gamma=0.99, epsilon=1.0, epsilon_min=0.05, epsilon_decay=0.99, lr=0.001,
        ...
        self.model_filename = f"dqn_model2_very_simple_2.pth"  # Model file for saving/loading
