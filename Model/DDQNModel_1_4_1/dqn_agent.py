...
class DDQNAgent:
    def __init__(self, color, game_service, persistent_model=None, gamma=0.99, epsilon=1.0, epsilon_min=0.05, epsilon_decay=0.995, lr=0.001,
        ...
        #print loss
        self.log_file = "ddqn141_training_loss.txt"
    ...
    def choose_action(self):
        ...
        if random.uniform(0, 1) < self.epsilon:
            ...
            with open("ddqn141_q_values.txt", "a") as f:
    ...
    def perform_action(self):
        ...
        with open("ddqn141_actions_log.txt", "a") as f:
            f.write(f"{action}\n")
        print("\n\n")
    ...
    def replay(self):
        ...
        with open("ddqn141_td_errors.txt", "a") as f:
    ...
    def save_model(self):
        ...
        try:
            ...
            with open("ddqn141_scores.txt", "a") as file:
