...
class PanelGUI:
    ...
    def create_left_column(self):
        ...
        agent_dropdown["values"] = ["RandomAgent", "AgentX", "QLearningAgent", "DeepQNetworkAgent","2DeepQNetworkAgent", "DDQNAgent", "2DDQNAgent", "DDQNAgent_PM", "DDQNAgent_1_2", "DDQNAgent_1_3"]
